...
Constraints: เลขที่รับค่าเข้ามาไม่ได้ระบุขอบเขตมาเพราะฉะนั้นเลขที่รับเข้ามาอาจจะเป็นเลขที่มีค่าสูงมากจนทำให้เกิด timeout ได้หากใช้วิธีการปกติ
...
วิธีสุดท้ายของฉันมีพื้นฐานจากวิธีแรกแต่มีการปรับเปลี่ยนในตัว for loop ให้เป็น NUMBER % i แทนและเปลี่ยนตัวขอบเขตใน for loop จาก 1, limit เป็น 2, limit + 1 แทน
